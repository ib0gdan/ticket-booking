...
// 3. Fetch Sessions
const { isPending, isError, data: sessions, error } = useQuery({
...
<template>
  <div class="w-full h-full p-8 max-w-5xl mx-auto">
    ...
    <div v-else>
      ...
      <div class="space-y-16">
        <div v-for="(moviesGroup, date) in groupedSessions" :key="date">
          ...
          <div class="space-y-12">
            <div v-for="group in moviesGroup" :key="group.movie.id" class="flex flex-col md:flex-row gap-8 items-start">
      ...
      <div v-if="Object.keys(groupedSessions).length === 0" class="text-center text-gray-400 py-12 font-light">
